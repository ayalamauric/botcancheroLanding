  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-100 to-gray-300">
      ...
      <main className="px-6 py-10">
        <h1 className="text-5xl font-extrabold text-center text-blue-900 my-12">Términos y Condiciones</h1>
        <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-2xl p-10">
          ...
          <div className="mt-12">
            ...
            <div className="mb-10">
              <h3 className="text-xl font-semibold mb-3">1.1</h3>
              ...
              <h3 className="text-xl font-semibold mb-3">1.2</h3>
              <p className="text-gray-800 mb-6 leading-relaxed">
              ...
              <h3 className="text-xl font-semibold mb-3">1.3</h3>
              <p className="text-gray-800 mb-6 leading-relaxed">
            ...
            <div className="mb-10">
              <h3 className="text-xl font-semibold mb-3">2.1</h3>
              <p className="text-gray-800 mb-6 leading-relaxed">
              ...
              <h3 className="text-xl font-semibold mb-3">2.2</h3>
              <p className="text-gray-800 mb-6 leading-relaxed">
            ...
            <div className="mb-10">
              <h3 className="text-xl font-semibold mb-3">3.1</h3>
              <p className="text-gray-800 mb-6 leading-relaxed">
              ...
              <h3 className="text-xl font-semibold mb-3">3.2</h3>
              <p className="text-gray-800 mb-6 leading-relaxed">
            ...
            <div className="mb-10">
              <h3 className="text-xl font-semibold mb-3">4.1</h3>
              <p className="text-gray-800 mb-6 leading-relaxed">
              ...
              <h3 className="text-xl font-semibold mb-3">4.2</h3>
              <p className="text-gray-800 mb-6 leading-relaxed">
            ...
            <div className="mb-10">
              <h3 className="text-xl font-semibold mb-3">5.1</h3>
              <p className="text-gray-800 mb-6 leading-relaxed">
              ...
              <h3 className="text-xl font-semibold mb-3">5.2</h3>
              <p className="text-gray-800 mb-6 leading-relaxed">
          ...
          <div className="flex items-center justify-center mt-12 bg-gradient-to-r from-red-700 via-red-600 to-red-500 text-white font-bold py-4 px-6 rounded-full max-w-4xl mx-auto">
            <span className="bg-red-800 px-4 py-2 rounded-l-full">IMPORTANTE</span>
            <span className="px-4">
